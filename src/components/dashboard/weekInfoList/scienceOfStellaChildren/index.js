...
function ScienceOfStellaChildren(props) {
  let { smallText, longText, isMore, moreClick, data, nextBtnClick } = props;
  return (
...
export default (ScienceOfStellaChildren = React.memo(ScienceOfStellaChildren));
