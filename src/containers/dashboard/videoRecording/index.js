...
class videoRecording extends Component {
  constructor(props) {
    ...
    // this.callUploadVideoRecordingApi()
  }

  async callUploadVideoRecordingApi(data1) {
    const data = new FormData();
    data.append("data", {
      name: "mobile-video-upload",
      type: "video/mp4",
      // type: type,
      // uri: 'file:///data/user/0/com.curioStellaTwo/cache/Camera/ba6764e2-d0b1-4214-bcc0-c5b8e80713bd.mp4'
      uri: data1.uri,
    });

    try {
      let json = await RestClient.postCallVideo(
        URL.UPLOAD_VIDEO_RECORDING,
        data
      );
    } catch (error) {
    }
    ...
    if (this.camera) {
      try {
        ...
        if (promise) {
          ...
          this.callUploadVideoRecordingApi(data);
        }
      } catch (e) {
        console.error(e);
      }
  ...
  render() {
    ...
    return (
      <View style={styles.homeContainer}>
        ...
        <Text style={{ textAlign: "center", fontSize: 14 }}>Record Video</Text>
