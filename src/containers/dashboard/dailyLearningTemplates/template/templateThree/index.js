...
const TemplateThreeComponent = lazy(() => import('@components/dashboard/dailyLearningTemplates/template/templateThree'));
...
export default connect(mapStateToProps, mapDispatchToProps)(TemplateThree);
